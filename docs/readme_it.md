<p align="center">
 ...
 <p align="center">Mostra nei tuoi README file le statistiche GitHub generate dinamicamente!</p>
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/andritianaa/github-readme-stats/issues/new/choose">Segnala un errore</a>
    ·
    <a href="https://github.com/andritianaa/github-readme-stats/issues/new/choose">Richiedi una nuova funzionalità</a>
  </p>
  <p align="center">
...
<p align="center">Se ti piace questo progetto, considera la possibilità di <a href="https://www.paypal.me/andritianaa">donare</a> per aiutare a renderlo migliore!
...
Since the GitHub API only allows 5k requests per hour, it is possible that my `https://github-readme-stats-andritianaa-ooo1fglx8-andritianaa.vercel.app/api` could hit the rate limiter. If you host it on your own Vercel server, then you don't have to worry about anything. Click on the deploy button to get started!
...
- [![paypal.me/andritianaa](https://ionicabizau.github.io/badges/paypal.svg)](https://www.paypal.me/andritianaa) - Fare una donazione via PayPal. Probabilmente compreròun ~~caffè~~ tè. :tea:
